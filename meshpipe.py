  ...
  try:
    ...
    while True:
      ...
      if not fifo_msg_in == "":
        ...
        #
        # Send to single NODE:  [CALLSIGN]|[MESSAGE]|[TO_SERVER_NODE_ID]
        # Send to broadcast:    [CALLSIGN]|[MESSAGE]
        # [dev] echo "edgey|r\edgey\alpha|433ee2ac" > /tmp/msgincoming
        #
        ...
        # Send as individual recipient when talking to meshmail server
        if array_len == 3:
